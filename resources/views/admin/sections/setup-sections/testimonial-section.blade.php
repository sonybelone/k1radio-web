                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>{{ $item->language->$system_default_lang->item_rating ?? "" }}</td>
                                <td>
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="edit-modal-{{ $item->name }}" role="tabpanel" aria-labelledby="edit-modal-{{$item->name}}-tab">
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                ...
                                                $data->value->language->$lang_code->item_designation ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Item Rating").'*',
                                                'type'      => "number",
                                                'name'      => $lang_code . "_item_rating_edit",
                                                'value'     => old($lang_code . "_item_rating_edit",
                                                $data->value->language->$lang_code->item_rating ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            $.each(languages,function(index,item) {
                ...
                editModal.find("input[name="+item.code+"_item_designation_edit]").val(oldData.language[item.code]?.item_designation);
                editModal.find("input[name="+item.code+"_item_description_edit]").val(oldData.language[item.code]?.item_description);
                editModal.find("input[name="+item.code+"_item_rating_edit]").val(oldData.language[item.code]?.item_rating);
            });
